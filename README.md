...
Desarrollador con más de un año de experiencia en **Python, Node, Flutter y Express**. Me especializo en unir el Frontend y Backend mediante el uso de **IA** (Claude/Gemini) para automatizar procesos y acelerar el desarrollo.
